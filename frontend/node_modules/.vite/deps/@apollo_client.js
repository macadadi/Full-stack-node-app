...
function getInclusionDirectives(directives) {
  ...
  if (directives && directives.length) {
    directives.forEach(function(directive) {
      ...
      invariant(ifValue && (ifValue.kind === "Variable" || ifValue.kind === "BooleanValue"), 71, directiveName);
...
function readMultipartBody(response, nextValue) {
  return __awaiter(this, void 0, void 0, function() {
    var decoder, contentType, delimiter, boundaryVal, boundary, buffer, iterator, running, _a, value, done, chunk, searchFrom, bi, message, i, headers, contentType_1, body, result2, next;
    var _b, _c;
    var _d;
...
var createHttpLink = function(linkOptions) {
  ...
  var _a = linkOptions.uri, uri = _a === void 0 ? "/graphql" : _a, preferredFetch = linkOptions.fetch, _b = linkOptions.print, print3 = _b === void 0 ? defaultPrinter : _b, includeExtensions = linkOptions.includeExtensions, preserveHeaderCase = linkOptions.preserveHeaderCase, useGETForQueries = linkOptions.useGETForQueries, _c = linkOptions.includeUnusedVariables, includeUnusedVariables = _c === void 0 ? false : _c, requestOptions = __rest(linkOptions, ["uri", "fetch", "print", "includeExtensions", "preserveHeaderCase", "useGETForQueries", "includeUnusedVariables"]);
  if (globalThis.__DEV__ !== false) {
  ...
  return new ApolloLink(function(operation) {
    ...
    if (context.clientAwareness) {
      var _a2 = context.clientAwareness, name_1 = _a2.name, version3 = _a2.version;
      if (name_1) {
  ...
  function() {
    ...
    StoreReader2.prototype.execSelectionSetImpl = function(_a) {
      ...
      function handleMissing(result3, resultName) {
        var _a2;
        if (result3.missing) {
          missing = missingMerger.merge(missing, (_a2 = {}, _a2[resultName] = result3.missing, _a2));
        }
...
var StoreWriter = (
  ...
  function() {
    ...
    StoreWriter2.prototype.writeToStore = function(store, _a) {
      var _this = this;
      var query = _a.query, result2 = _a.result, dataId = _a.dataId, variables = _a.variables, overwrite = _a.overwrite;
    ...
    StoreWriter2.prototype.processSelectionSet = function(_a) {
      var _this = this;
      var dataId = _a.dataId, result2 = _a.result, selectionSet = _a.selectionSet, context = _a.context, mergeTree = _a.mergeTree;
      ...
      this.flattenFields(
        ...
        !policies.getReadFunction(typename, field.name.value)) {
          globalThis.__DEV__ !== false && invariant.error(12, resultKeyNameFromField(field), result2);
        }
      });
      try {
    ...
    InternalQueryReference2.prototype.handleNext = function(result2) {
      ...
      switch (this.promise.status) {
        case "pending": {
          ...
          this.result = result2;
          (_a = this.resolve) === null || _a === void 0 ? void 0 : _a.call(this, result2);
          break;
        }
        default: {
